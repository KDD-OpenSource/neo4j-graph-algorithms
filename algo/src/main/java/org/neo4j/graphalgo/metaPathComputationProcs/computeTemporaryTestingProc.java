...
public class computeTemporaryTestingProc {
    @Context
    ...
    @Procedure("algo.computeTemporaryTesting")
    @Description("CALL algo.computeTemporaryTesting(length:int) YIELD length: \n" +
    ...
    public Stream<ComputeAllMetaPathsResult> computeTemporaryTesting(
